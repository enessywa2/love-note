...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        soft: "0 2px 16px 0 rgba(0,0,0,0.04), 0 1px 4px 0 rgba(0,0,0,0.03)",
        "soft-lg": "0 4px 24px 0 rgba(0,0,0,0.06), 0 2px 8px 0 rgba(0,0,0,0.04)",
        glow: "0 0 20px rgba(236, 112, 146, 0.15)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "emoji-burst": "emoji-burst 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "jelly": "jelly 0.5s cubic-bezier(0.16, 1, 0.3, 1)",
