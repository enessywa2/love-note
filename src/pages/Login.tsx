      ...
      <div className="w-full max-w-md animate-fade-up">
        ...
        <div className="glass-card p-8 rounded-[2rem] shadow-2xl border border-white/20 backdrop-blur-xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" className="w-full h-12 rounded-xl font-bold text-lg transition-all hover:scale-[1.02] active:scale-[0.98] shadow-glow" disabled={isLoading}>
              {isLoading ? <Loader2 className="animate-spin" /> : <>Login <ArrowRight className="ml-2" size={18} /></>}
            </Button>
          </form>
